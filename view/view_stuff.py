...
class View_Stuff:
    def __init__(self):
        self.win = Tk()
        self.win.title("Stuff")
        self.win.geometry("800x700")

        Label(self.win, text="you are in Stuff", font=("sega", 20), fg = 'grey19',bg='honeydew2').pack()
        #name
        self.tn = StringVar ( )
        ...
        #model
        self.tm = StringVar ( )
        Label ( self.win, text = "model :", font = ("Arial", 10) ).place ( x = 20, y = 120 )
        self.ent_m = Entry ( self.win, textvariable = self.tm, bg = "lightgray", font = ("Arial", 10) )
        self.ent_m.place ( x = 100, y = 70, height = 40, width = 90 )

        #brand
        self.tb = StringVar ( )
        Label ( self.win, text = "brand :", font = ("Arial", 10) ).place ( x = 20, y = 70 )
        self.ent_b = Entry ( self.win, textvariable = self.tb, bg = "lightgray", font = ("Arial", 10) )
        self.ent_b.place ( x = 100, y = 120, height = 40, width = 90 )

        #descripstion
        self.td = StringVar ( )
        Label ( self.win, text = "description :", font = ("Arial", 10) ).place ( x = 20, y = 220 )
        self.ent_d = Entry ( self.win, textvariable = self.td, bg = "lightgray", fg = 'black', font = ("Arial", 20) )
        self.ent_d.place ( x = 100, y = 220, height = 100, width = 120 )

        #buy_price
        self.tp = StringVar ( )
        Label ( self.win, text = "buy price :", font = ("Arial", 10) ).place ( x = 20, y = 170 )
        self.ent_p = Entry ( self.win, textvariable = self.tp, bg = "lightgray", font = ("Arial", 10) )
        self.ent_p.place ( x = 100, y = 170, height = 40, width = 90 )
